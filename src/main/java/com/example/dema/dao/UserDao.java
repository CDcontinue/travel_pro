...
public interface UserDao {
    ...
    @Results({
            ...
            @Result(property = "roles",column = "id",javaType = List.class,many = @Many(select = "com.example.dema.dao.RoleDao.findRoleByUserId"))
    })
    ...
    public UserInfo findUser(@Param("account") String Username, @Param("password") String Password) throws Exception;
...
//    //修改用户信息
//    @Update("update user set phone=#{phone},email=#{email} where id=#{userId}")
